...
\\
\>[B]{}\Varid{discollect}\;\Varid{x}\mathrel{=}\Varid{set}\;[\mskip1.5mu \Varid{k}\mapsto\Varid{y}\mid (\Varid{k},\Varid{d})\leftarrow \Varid{x},\Varid{y}\leftarrow \Varid{d}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g1}\;\Varid{v}\mathrel{=}[\mskip1.5mu ([\mskip1.5mu \mskip1.5mu],\Varid{v})\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g2}\;(\Varid{o},\Varid{listapares})\mathrel{=}\map \;((\Varid{o}\plus )\times\Varid{id})\mathbin{\$}\Varid{concat}\;\Varid{listapares}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 rd}\;\Varid{s}\;\Varid{d}\mathrel{=}\Varid{lookup}\;(\map \;\Varid{toUpper}\;\Varid{s})\;(\Varid{dic\char95 exp}\;\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 in}\;\Varid{a}\;\Varid{b}\;\Varid{c}\mathrel{=}\Varid{dic\char95 imp}\;(\Varid{collect}\;((\plus )\;(\Varid{singl}\;\conj{\p1}{{}\<[56]%
\>[56]{}\p2}\;((\mapsto)\;\Varid{a}\;\Varid{b}))\;(\Varid{discollect}\;(\Varid{dic\char95 exp}\;(\Varid{c}))))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\bot \mbox{\onelinecomment split (either h1 h2) (either k1 k2) where }{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mbox{\onelinecomment h1 = undefined}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mbox{\onelinecomment h2 = undefined}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mbox{\onelinecomment k1 = undefined}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mbox{\onelinecomment k2 = undefined}{}\<[E]%
\\[\blanklineskip]%
