...
public class PalletDAO {
    ...
    public Map<String, Pair<List<String>, String>> getPalletsLocations() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                pallets.put(
                        id, new Pair<>(Arrays.asList(product, quantity, company, type), station));
            }
            conn.close();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public Map<String, Pair<Pallet,String>> getPalletsFrom(int location){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                res.put(id,new Pair(new Pallet(id,product,Integer.valueOf(quantity),company,type),status));
            }
    ...
    public Pallet remove(Object key) {
        ...
        try {
            ...
            Statement stm = conn.createStatement();
            String sql =
                    "DELETE FROM Pallet WHERE IDPallet = '"
                            + key
                            + "'";
