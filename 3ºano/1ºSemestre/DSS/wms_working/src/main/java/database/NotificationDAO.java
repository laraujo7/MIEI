...
public class NotificationDAO implements Map<String, Notification> {
    ...
    @Override
    public void replaceAll(BiFunction<? super String, ? super Notification, ? extends Notification> function) {
    ...
    @Override
    public Notification computeIfAbsent(String key, Function<? super String, ? extends Notification> mappingFunction) {
        return null;
    }

    @Override
    public Notification computeIfPresent(String key, BiFunction<? super String, ? super Notification, ? extends Notification> remappingFunction) {
        return null;
    }

    @Override
    public Notification compute(String key, BiFunction<? super String, ? super Notification, ? extends Notification> remappingFunction) {
        return null;
    }

    @Override
    public Notification merge(String key, Notification value, BiFunction<? super Notification, ? super Notification, ? extends Notification> remappingFunction) {
        return null;
    }
