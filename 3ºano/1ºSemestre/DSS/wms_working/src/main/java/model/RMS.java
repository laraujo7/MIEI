...
public class RMS implements IRMS {
    ...
    public void robotNotifiesPickUp(String robotId, String idJob, PalletDAO palletDAO) {
        ...
        switch (idStation) {
            ...
            default:
                notificationDAO.putNotification("ROBOT \"ROB" + robotId + "\" PICKED UP " + palletDAO.get(idPallet).getType().toUpperCase() + " PALLET \"PAL" + idPallet + "\" FROM SHELF \"SHE" + idStation + "\"");
        }
    }
    ...
    public void robotNotifiesDelivery(String robotId, String idJob, PalletDAO palletDAO) {
        ...
        switch (idStation) {
            case "1":
                notificationDAO.putNotification("ROBOT \"ROB" + robotId + "\" DROPPED " + palletDAO.get(idPallet).getType().toUpperCase() + " PALLET \"PAL" + idPallet + "\" IN RECEIVING STATION");
                break;

            case "2":
                notificationDAO.putNotification("ROBOT \"ROB" + robotId + "\" DROPPED " + palletDAO.get(idPallet).getType().toUpperCase() + " PALLET \"PAL" + idPallet + "\" IN SHIPPING STATION");
                break;

            default:
                notificationDAO.putNotification("ROBOT \"ROB" + robotId + "\" DROPPED " + palletDAO.get(idPallet).getType().toUpperCase() + " PALLET \"PAL" + idPallet + "\" IN SHELF \"SHE" + idStation + "\"");
        }
