...
public class WMS implements IWMS {
        ...
        this.ums
                ...
                .forEach(
                        entry -> {
                            ...
                            lastPallets.add(Arrays.asList(entry.getId(),entry.getQuantity().toString(),entry.getCompany(),entry.getProduct(),"IN"));
    ...
    @Override
    public void changeStatus(String palletID) {this.palletDAO.changeStatus(palletID);}
