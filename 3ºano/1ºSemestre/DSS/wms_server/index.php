...
<html lang="en" class="h-75">
    ...
    ================================================== -->
        ...
        <div id="app" class="container h-100 mw-100 user-select-auto">
            ...
            <div class="align-items-stretch flex-row h-100 row">
                ...
                <div class="border col-md mt-0 pt-3">
                    <div class="input-group mb-3 mw-100">
                        <input type="text" v-model='name_filter' class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2" placeholder="Product Name">
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="button" @click="filterName()">Search
                                <br>
                            </button>
                        </div>
                    </div>
            ...
            <div id="sucessful" class="alert alert-success"  data-dismiss="alert" style="display:none;">
              <strong>Success!</strong> Request entry created!</a>.
            </div>
        </div>
